...
namespace SIMHUKDIS.Models
{
    public class clsKumpulanSK
    {
        ...
        public string JENIS_SK { get; set; }
        public string KODE_JENIS_SK { get; set; }
    ...
    public class clsKumpulanSKDB
    {
        public List<clsKumpulanSK> PS(string userid, string groupID)
        {
            ...
            {
                string q = "sp_KumpulanSK_Display";
        ...
        public int Insert(clsKumpulanSK PS)
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                ...
                DateTime TANGGAL_SK = DateTime.ParseExact(PS.TANGGAL_SK, "dd MMMM yyyy", null);
        ...
        public clsSuratMasukMsgInfo GetPSMsgInfo(string NO_SK, string NIP, int Status)
        {
            string constr = ConfigurationManager.ConnectionStrings["dbHukdis"].ConnectionString;
            clsSuratMasukMsgInfo data = new clsSuratMasukMsgInfo();
            using (SqlConnection con = new SqlConnection(constr))
            {
                string q = "SP_MESSAGEINFO_PenyampaianSatker";
                SqlCommand cmd = new SqlCommand(q, con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@NO_SK", NO_SK);
